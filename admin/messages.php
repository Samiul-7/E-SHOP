...
<section class="messages">
   ...
   ?>
   <div class="box">
      <p> User Name : <span><?= $fetch_messages['user_name'] ?: 'Guest'; ?></span> </p>
      <p> User Email : <span><?= $fetch_messages['user_email'] ?: 'N/A'; ?></span> </p>
      <p> Message Name : <span><?= $fetch_messages['name']; ?></span> </p>
